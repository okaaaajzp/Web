<template>
	<div class="login">
		<el-form class="login-container">
			...
			<el-form-item label="">
				<el-input type="text" v-model="user.email" placeholder="邮箱" autocomplete="off"></el-input>
			</el-form-item>
			<el-form-item label="">
				<el-input type="password" v-model="user.password" placeholder="登录密码" autocomplete="off" @keydown.enter.native="login"></el-input>
			</el-form-item>
			<el-form-item>
				<el-button type="primary" style="width:100%;" @click="login()">登录</el-button>
			</el-form-item>
			<el-row style="text-align: center;margin-top:-10px;">
				<el-link type="primary" @click="gotoRegister()" style="margin-left: 20px;">用户注册</el-link>
			</el-row>
		</el-form>
	</div>
</template>
