	...
	<div class="register">
		<el-form class="register-container">
			...
			<el-row style="margin-top: 0px;" label="">
				<el-input type="text" v-model="user.name" placeholder="用户名" autocomplete="off" maxlength="16"></el-input>
			</el-row>
			<el-row style="margin-top: 20px;" label="">
				<el-input type="password" v-model="user.password" placeholder="登录密码" autocomplete="off" maxlength="20"></el-input>
			</el-row>
            <el-row style="margin-top: 20px;" label="">
				<el-input type="password" v-model="passwordAgain" placeholder="确认密码" autocomplete="off" maxlength="20"></el-input>
			</el-row>
			<el-row label="" :gutter="2" style="margin-top: 20px;">
				<el-col :span="16">
					<el-input type="text" label-width="20" v-model="user.email" placeholder="邮箱" autocomplete="off" ></el-input>
				</el-col>
				<el-col :span="8">
            ...
            <el-row style="margin-top: 20px;" label="">
				<el-input type="text" v-model="code" placeholder="验证码" autocomplete="off" maxlength="6"></el-input>
			</el-row>
  ...
  ,methods:{
    register(){
        if(this.passwordAgain != this.user.password){
            this.$message.error("请确保两次密码一致")
        }
        else{
            request.post("/user/register?code="+this.code,this.user).then(res =>{
                if(res.code === 0){
	...
	getCode(){
        ...
        request.post("/user/getCode/"+this.user.email).then(res =>{
            if(res.code === 0){
